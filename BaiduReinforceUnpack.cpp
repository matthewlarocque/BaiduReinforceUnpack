...
BEGIN_MESSAGE_MAP(CBaiduReinforceUnpackApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


CBaiduReinforceUnpackApp::CBaiduReinforceUnpackApp()
{
...
CBaiduReinforceUnpackApp theApp;


BOOL CBaiduReinforceUnpackApp::InitInstance()
{
